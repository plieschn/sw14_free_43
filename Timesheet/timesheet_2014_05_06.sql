...
--
-- Host: localhost
-- Erstellungszeit: 06. Jun 2014 um 13:40
...
CREATE TABLE IF NOT EXISTS `entries` (
  ...
  `notes` text NOT NULL,
  `coding_percentage` decimal(3,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(13, 1, 5, '2014-04-16 16:00:00', '2014-04-16 18:00:00', 'Visual improvements (Action bar icon change on start/stop).', '0.90');
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `coding_percentage` decimal(3,2) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;
...
(1, 'visit lecture', '0.00'),
(2, 'learn for mid term exam', '0.00'),
(3, 'learn for end term exam', '0.00'),
(4, 'project preparation', '0.00'),
(5, 'project', '1.00'),
(6, 'project refactoring', '0.80');
