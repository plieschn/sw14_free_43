...
--
-- Host: localhost
-- Erstellungszeit: 15. Jun 2014 um 00:01
...
(1, 'plieschn', '*8CDA35FD2F78B711A87C25F2A2CBEBCF8615BDCA', 'Markus', 'Plieschnegger', 'BSc', 1, '2014-06-13 14:16:52');
...
CREATE TABLE IF NOT EXISTS `point` (
  ...
  `lontitude` decimal(8,5) NOT NULL,
...
--
ALTER TABLE `point`
  ADD CONSTRAINT `point_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`),
  ADD CONSTRAINT `point_ibfk_2` FOREIGN KEY (`track_id`) REFERENCES `track` (`id`);

--
-- Constraints der Tabelle `track`
--
ALTER TABLE `track`
  ADD CONSTRAINT `track_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`);
